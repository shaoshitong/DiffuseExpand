...
parser.add_argument('--startswith', type=str, default="image",
                    help='choose image to compute')
...
def calculate_fid_given_paths(checkpoint, paths, batch_size, device, dims, startswith, num_workers=1):
    ...
    param = torch.load(checkpoint,map_location="cpu")
...
def main():
    ...
    fid_value = calculate_fid_given_paths(args.checkpoint,
                                          args.path,
                                          args.batch_size,
                                          device,
                                          args.dims,
