...
def main(args):
    ...
    optimizer_lr = torch.optim.SGD([syn_lr], lr=args.lr_lr, momentum=0.5) # TODO: question, why optimize syn_lr?
    ...
    if args.load_all: # TODO: load expert models
        buffer = []
        n = 0
    ...
    for it in range(0, args.Iteration+1):
        ...
        if it in eval_it_pool: # TODO: select some iteration for evaling ...
            for model_eval in model_eval_pool:
                ...
                for it_eval in range(args.num_eval):
                    ...
                    # TODO: dataset build by dataset distillation
        ...
        if args.distributed:
            student_net = torch.nn.DataParallel(student_net) # TODO: build ddp
        ...
        # TODO: setting model's parameter in training begin and end
        ...
        grand_loss = param_loss # TODO: compute mse/mse loss
