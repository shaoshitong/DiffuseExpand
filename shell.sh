...
python eval.py --dataset=CGMH --loss_type sigmoid_l1 --model=Unet --train_epochs=50 --generate_data_path /home/sst/product/Synthetic-Medical-Images/pytorch_Stage_I/images \
